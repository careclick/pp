<template>
  <div>
    <modal name="searchchangepassword" :scrollable="true" :adaptive="true" height="auto" :width="400">
      <div>
...
<script>
  export default {
    props:['patient_id','patient_name','role'],
     data(){
       return{
         loading:false,
     ...
     methods:{
       ...
       hideModal(){
         this.$modal.hide('searchchangepassword')
       }
     },
     computed:{
       getFirstName(){
